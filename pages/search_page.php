            ...
            <div class = "search-box">
                ...
                <div class = "result-box">
                 ...
                 <select class="category_dropdown">
                    ...
                    <option value="Aveiro">Beja</option>
                    <option value="Aveiro">Braga</option>
                    <option value="Aveiro">Bragança</option>
                    <option value="Aveiro">Castelo Branco</option>
                    <option value="Aveiro">Coimbra</option>
                    <option value="Aveiro">Évora</option>
                    <option value="Aveiro">Faro</option>
                    <option value="Aveiro">Guarda</option>
                    <option value="Aveiro">Leiria</option>
                    <option value="Aveiro">Lisboa</option>
                    <option value="Aveiro">Portalegre</option>
                    <option value="Aveiro">Porto</option>
                    <option value="Aveiro">Santarém</option>
                    <option value="Aveiro">Setúbal</option>
                    <option value="Aveiro">Viana do Castelo</option>
                    <option value="Aveiro">Vila Real</option>
                    <option value="Aveiro">Viseu</option>
                 </select>
